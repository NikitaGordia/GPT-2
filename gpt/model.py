...
class GPT(nn.Module):
    ...
    def forward(
        ...
        position = torch.arange(0, T, dtype=torch.long, device=ids.device)
    ...
    def from_pretrained(cls, model_type: str) -> "GPT":
        ...
        print(f"loading weigts from pretrained gpt: {model_type}")
        available_configs = {
        ...
        config_args = available_configs[model_type]
    ...
    def configure_optimizers(
        self, weight_decay: float, learning_rate: float, env
        ...
        use_fused = fused_available and env.device_type == "cuda"
